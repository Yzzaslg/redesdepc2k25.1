'''Um robô pode se mover em oito sentidos em um plano cartesiano: U (cima); D (baixo); R (direita); L (esquerda); O (noroeste/cima-esquerda); N (nordeste/cima-direita); E (sudeste/baixo-direita) e W (sudoeste/baixo-esquerda).

Faça um programa que:

Solicite ao usuário a posição inicial do robô (suas coordenadas X e Y);
Solicite ao usuário uma string. Letras maiúsculas e minúsculas são indistintas e aquelas informadas que estejam fora das estabelecidas (U, D, R, L, O, N, E e W) devem ser ignoradas;
