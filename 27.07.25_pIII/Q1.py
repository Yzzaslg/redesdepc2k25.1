...
list_origem = [[random.randint(0, 100) for _ in range(n_colunas)] for _ in range(n_linhas)] # random.randint vai gerar os elementos dado em () de forma aleatória, primero for in range() vai gerar uma sublista com a quantidade de elementos e o segundo for in range() repete essa sublista várias vezes.
